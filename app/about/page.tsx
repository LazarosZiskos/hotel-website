  ...
  return (
    <main>
      <section className="container mt-10 mb-10">
        ...
        <div>
          <h1 className="pb-8 text-4xl">About Hotel Hellas</h1>
          <div className="leading-loose">
            <p className="text-[14px]">
              Welcome to our family-run hotel in the heart of Paralia Katerini,
            ...
            <p className="pt-4 text-[14px] ">
              With 23 thoughtfully designed rooms, including single, double,
              triple, and family accommodations, we cater to the diverse needs
              of our guests. Each room is equipped with modern amenities such as
              a 32-inch flat-screen TV, air conditioning, a fully equipped
              kitchenette, and complimentary high-speed WiFi, ensuring a
            ...
            <p className="pt-4 text-[14px]">
              ...
              home away from home, we invite you to join our family at Hotel
              Hellas.
            </p>
            <p className="pt-4 text-[14px]">
